...
│   └── 📎 paper3_beni_pipeline/ ← symlink → ../../papers/paper3_beni_method/...
│
...
| `paper/paper3_beni_pipeline` (symlink) | `papers/paper3_beni_method/manuscript/paper3_beni_pipeline/` | Canonical Paper 3 manuscript |
...
| Folder | Relationship |
|--------|-------------|
| `beni/` | **Upstream** — `data-paper/` contains canonical snapshots of `beni/` outputs |
| `papers/paper3_beni_method/` | **Peer** — Paper 3's `data/processed/` symlinks here |
| `distribution/` | **Downstream** — Distribution manifests reference this folder's content |
| `papers/paper3_beni_pipeline/` (symlink) | **Reference** — Links to the Paper 3 manuscript that uses this data |
