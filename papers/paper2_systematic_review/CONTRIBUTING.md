...
**Log your results** in `papers/contributions/OWNERS.csv` with `role=Replicator`.
...
**Log your audit** in `papers/contributions/paper2_extraction_log.csv`.
...
- Use the screening template in `papers/contributions/paper2_screening_log.csv`
...
After completing any task, log it in `papers/contributions/OWNERS.csv`:
...
For screening or extraction tasks, also update the respective log in `papers/contributions/`.
