...
\textbf{arXiv:} econ.EM (Primary), q-fin.ST, cs.CL
...
The empirical sample also spans several more specialized applications. Financial-market and corporate-disclosure studies include Hájek and Olej (2013), Kräussl and Mirgorodskaya (2017), Hassan et al. (2019), Gite et al. (2021), Liapis et al. (2023), Zhang et al. (2024), and Adämmer and Schüssler (2020), the latter showing that news topics can improve equity-premium forecasts. Macroeconomic nowcasting and inflation applications include Bortoli et al. (2018), Caruso (2019), Ardia et al. (2019), Jones et al. (2020), Clements and Reade (2020), Shapiro et al. (2022), Ashwin et al. (2021), Lukauskas et al. (2022), Jiang et al. (2022), Ellingsen et al. (2022), Barbaglia et al. (2023), Allard et al. (2024), Rogmann et al. (2024), Beiranvand et al. (2024), Simionescu and Nicula (2024), Matos (2024), Seo (2025), Weinig and Fritsche (2025), and Kaczmarek et al. (2025). Policy-uncertainty, geopolitical-risk, and institutional communication studies include Baker et al. (2016), Gavaldon (2017), Castle et al. (2017), Choudhary et al. (2020), Aharon et al. (2022), Caldara and Iacoviello (2022), Gardner et al. (2022), Tkacova and Gavurova (2023), Cummins et al. (2024), Garcia (2024), and the San Francisco Federal Reserve Bank (2025). Theoretical and methodological contributions retained for context include Gentzkow et al. (2019), Andre et al. (2021), Korinek (2023), Lange et al. (2022), Bieri (2025), Borja et al. (2024), Groß-Klußmann (2024), and Andre et al. (2024).
...
\end{tikzpicture}
\raggedright\footnotesize
\textit{Note:} Bar chart shows number of papers by geographic region (N=66). North America dominates with 37 papers (56\%). Three regions---Africa, Latin America, and the Middle East---have zero studies, representing a critical research gap. Regional totals sum to 63 because 3 theoretical papers without country-specific focus are not assigned to a single region. Multi-region assignment, consistent with Table~1.
\end{figure*}
...
Random Forests, SVM, and neural networks gain traction. Hong et al. (2025) find Random Forests superior for inflation forecasting, capturing non-linear relationships. Deep learning approaches (LSTM, CNN) added but require substantial training data (5,000--50,000 labeled examples typical).
...
\midrule
GDP / Industrial Production & Q / Monthly & 10--50\% RMSE & Thorsrud 2020, Barbaglia 2024 \\
Inflation (CPI) & 6--12 months & 20--30\% RMSE & Hong et al. 2025, Eugster \& Uhl 2024 \\
Stock Volatility & 1--6 months & Strong (VIX) & Da et al. 2015, Audrino 2024 \\
Equity Returns & 1--6 months & 30\% RMSE & Tetlock 2007, Ren et al. 2019 \\
...
\midrule
North America & 28 & 61\% & — \\
Europe & 13 & 28\% & Southern/Eastern Europe \\
East/Southeast Asia & 4 & 9\% & Indonesia, Thailand, Vietnam \\
...
\bibitem{Paper2} Hájek, P., \& Olej, V. (2013). Evaluating Sentiment in Annual Reports for Financial Distress Prediction Using Neural Networks and Support Vector Machines. \textit{Communications in Computer and Information Science}, 384, 1--10.
...
\bibitem{Paper6} Kräussl, R., \& Mirgorodskaya, E. (2017). Media, sentiment and market performance in the long run. \textit{European Journal of Finance}, 23(11), 1059--1082.
...
\bibitem{Paper24} Adämmer, P., \& Schüssler, R. A. (2020). Forecasting the Equity Premium: Mind the News! \textit{Review of Finance}, 24(6), 1313--1355.
...
\bibitem{Paper44} Hong, Y., Jiang, F., Meng, L., \& Xue, B. (2025). Forecasting Inflation Using Economic Narratives. \textit{Journal of Business \& Economic Statistics}, 43(1), 216--231.

\bibitem{Paper45} Korinek, A. (2023). Generative AI for economic research: Use cases and implications for economists. \textit{Journal of Economic Literature}, 61(4), 1281--1317.

\bibitem{Paper46} Liapis, C. M., Karanikola, S., \& Kotsiantis, S. (2023). Investigating Deep Stock Market Forecasting with Sentiment Analysis. \textit{Entropy}, 25(2), 219.
...
\bibitem{Paper48} Zhang, Z., Keasey, K., Lambrinoudakis, C., \& Mascia, D. V. (2024). Consumer sentiment: The influence of social media. \textit{Economics Letters}, 237, 111638.
...
\bibitem{Paper50} Barbaglia, L., Consoli, S., \& Manzan, S. (2024). Forecasting GDP in Europe with Textual Data. \textit{Journal of Applied Econometrics}, 39(2), 338--355.

\bibitem{Paper51} Eugster, P., \& Uhl, M. W. (2024). Forecasting inflation using sentiment. \textit{Economics Letters}, 236, 111584.

\bibitem{Paper52} Groß-Klußmann, A. (2024). Learning deep news sentiment representations for macro-finance. \textit{Digital Finance}, 6(3), 341--377.

\bibitem{Paper53} Rogmann, J., Beckmann, J., Gaschler, R., \& Landmann, H. (2024). Media sentiment emotions and consumer energy prices. \textit{Energy Economics}, 130, 107278.

\bibitem{Paper54} Andre, P., Haaland, I., Roth, C., Wiederholt, M., \& Wohlfart, J. (2024). Narratives about the macroeconomy. \textit{SAFE Working Paper Series}, No. 426.

\bibitem{Paper55} Beiranvand, M., Malek Sadati, S. S., \& Razmi, S. M. J. (2024). Nowcasting Iran's GDP using sentiment analysis of economic news. \textit{Quarterly Journal of Applied Theories of Economics}, 11(3), 135--164.

\bibitem{Paper56} Borja, K. J. V., Chambal, V. S., \& Wangli, D. L. (2024). Predictive Analysis of Economic Vulnerability Using News Data. \textit{SSRN Working Paper}.

\bibitem{Paper57} Talazadeh, S., \& Peraković, D. (2024). SARF: Stock Market Prediction with Sentiment-Augmented Random Forest. \textit{Lecture Notes of the Institute for Computer Sciences, Social Informatics and Telecommunications Engineering}, 54--64.

\bibitem{Paper58} Simionescu, M., \& Nicula, A. S. (2024). Sentiment Analysis as Innovation in the Inflation Forecasting in Romania. \textit{Marketing and Management of Innovations}, 15(2), 13--25.

\bibitem{Paper59} Audrino, F., \& Offner, E. A. (2024). The impact of macroeconomic news sentiment on interest rates. \textit{International Review of Financial Analysis}, 94, 103293.
...
\bibitem{Paper62} Matos, J. M. P. de. (2024). Using Twitter news sentiment analysis to forecast US GDP. \textit{Master's thesis, NOVA Information Management School, Universidade Nova de Lisboa}.

\bibitem{Paper63} Seo, B. (2025). Econometric forecasting using ubiquitous news text: Text-enhanced factor model. \textit{International Journal of Forecasting}, 41(3), 1055--1072.

\bibitem{Paper64} Weinig, M., \& Fritsche, U. (2025). Going viral: Inflation narratives and the macroeconomy. \textit{WiSo-HH Working Paper Series}, No. 86.

\bibitem{Paper65} Kaczmarek, I., Iwaniak, A., Chrobak, G., \& Kazak, J. K. (2025). Integrating media sentiment with traditional economic indicators: a study on PMI, CCI, and employment during COVID-19 period in Poland. \textit{Journal of Computational Social Science}, 8(2), 1--23.
