...
```bash
python3 papers/paper5_text_as_data_survey/scripts/search_crossref_candidates.py --rows 40
```
...
```bash
python3 papers/paper5_text_as_data_survey/scripts/screen_crossref_candidates.py
```
...
```bash
python3 papers/paper5_text_as_data_survey/scripts/download_candidate_pdfs.py --priority screen_first
python3 papers/paper5_text_as_data_survey/scripts/download_candidate_pdfs.py --priority all --manifest papers/paper5_text_as_data_survey/literature/download_manifest_all.csv
```
