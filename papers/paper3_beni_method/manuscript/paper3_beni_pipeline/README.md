...
| `data-paper/paper/paper3_beni_pipeline` | `papers/paper3_beni_method/manuscript/paper3_beni_pipeline/` (via `../../`) |
...
- **Data**: The manuscript uses `papers/paper3_beni_method/data/` which includes symlinks to `data-paper/data/` for canonical files
