...
```bash
mkdir -p papers/extensions/[your_extension_name]/{data,scripts,manuscript,results}
cp papers/extensions/EXTENSION_TEMPLATE.md papers/extensions/[your_extension_name]/README.md
echo "Your Name,Extension Author,papers/extensions/[your_extension_name],in_progress,2026-06-10," >> papers/contributions/OWNERS.csv
```
