...
| File | Description |
|------|-------------|
| `papers/extensions/[your_replication]/replication_report.md` | This report |
| `papers/extensions/[your_replication]/results/` | Your output files |
| `papers/extensions/[your_replication]/scripts/` | Modified or additional scripts |
...
```bash
mkdir -p papers/extensions/[your_replication]/{results,scripts}
cp papers/extensions/REPLICATION_TEMPLATE.md papers/extensions/[your_replication]/README.md
echo "Your Name,Replicator,papers/extensions/[your_replication],completed,2026-06-10,2026-06-15" >> papers/contributions/OWNERS.csv
```
