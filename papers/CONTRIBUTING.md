...
1. **Open the screening queue**: `papers/contributions/paper{screening_log.csv`
...
1. **Open the extraction log**: `papers/contributions/paper_extraction_log.csv`
...
### Process
1. Check `papers/contributions/OWNERS.csv` for which sections have assigned writers
...
1. Check `papers/paper2_systematic_review/replications/` for existing scripts
