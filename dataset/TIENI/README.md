...
```
TIENI/
├── raw/            # Raw Tagalog news articles (place scraped data here)
│   ├── .gitkeep
...
1. **Identify sources** — Online Tagalog news portals (e.g., ABS-CBN News, GMA News, Inquirer, Pilipino Star Ngayon)
