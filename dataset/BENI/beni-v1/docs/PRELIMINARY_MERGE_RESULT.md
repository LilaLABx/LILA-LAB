...
| Output | Purpose |
|---|---|
| `data/processed/potrika_articles_canonical.csv.zst` | Compressed canonical Potrika articles. |
| `data/processed/bnad_articles_canonical.csv.zst` | Compressed canonical BNAD post-2020 articles. |
| `data/processed/beni_unified_articles.csv.zst` | Compressed merged article file. |
| `data/processed/beni_unified_articles_deduped.csv.zst` | Compressed merged file with exact duplicate text flags. |
