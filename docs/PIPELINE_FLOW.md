...
| **Classification & index** | TF-IDF / BanglaBERT models build the monthly BENI index | [pipelines/BENI/indices/eco/build_narrative_index.py](https://github.com/LilaLABx/LILA-LAB/blob/main/pipelines/BENI/indices/eco/build_narrative_index.py) |
